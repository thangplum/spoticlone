...
export const Genre: React.FC<GenreProps> = () => {
  ...
  useEffect(() => {
    const [nameSource, requestName] = createRequest(`https://api.spotify.com/v1/browse/categories/${id}`)
    const [listSource, requestList] = createRequest(`https://api.spotify.com/v1/browse/categories/${id}/playlists?limit=50`)
